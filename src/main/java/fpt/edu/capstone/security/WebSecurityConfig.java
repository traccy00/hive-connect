...
//    };
//
//    public WebSecurityConfig(MyAuthenticationEntryPoint jwtAuthenticationEntryPoint, UserDetailsService jwtUserDetailsService, RequestFilter jwtRequestFilter) {
//        this.myAuthenticationEntryPoint = jwtAuthenticationEntryPoint;
