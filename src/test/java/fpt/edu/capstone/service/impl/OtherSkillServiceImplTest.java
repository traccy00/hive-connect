...
public class OtherSkillServiceImplTest {
    ...
    public void testGetListOtherSkillByCvId() {
        ...
        when(otherSkillServiceImplUnderTest.otherSkillRepository.getListOtherSkillByCvId(0L)).thenReturn(otherSkills);
        final List<OtherSkill> result = otherSkillServiceImplUnderTest.getListOtherSkillByCvId(0L);
    }

    @Test
    public void testGetListOtherSkillByCvId_OtherSkillRepositoryReturnsNoItems() {
        when(otherSkillServiceImplUnderTest.otherSkillRepository.getListOtherSkillByCvId(0L))
    ...
    public void testInsertOtherSkill() {
        ...
        final OtherSkill otherSkill = new OtherSkill(0L, "skillName", 0L, "level");
    ...
    public void testUpdateOtherSKill() {
        ...
        verify(otherSkillServiceImplUnderTest.otherSkillRepository).updateOtherSkill("skillName", "level", 0L);
    }
    ...
    public void testDeleteOtherSkill() {
        ...
        verify(otherSkillServiceImplUnderTest.otherSkillRepository).deleteOtherSkill(0L);
    }

    @Test
    public void testGetOtherSkillById() {
        final Optional<OtherSkill> otherSkill = Optional.of(new OtherSkill(0L, "skillName", 0L, "level"));
        when(otherSkillServiceImplUnderTest.otherSkillRepository.findById(0L)).thenReturn(otherSkill);
        final Optional<OtherSkill> result = otherSkillServiceImplUnderTest.getOtherSkillById(0L);
    }

    @Test
    public void testGetOtherSkillById_OtherSkillRepositoryReturnsAbsent() {
        when(otherSkillServiceImplUnderTest.otherSkillRepository.findById(0L)).thenReturn(Optional.empty());
        final Optional<OtherSkill> result = otherSkillServiceImplUnderTest.getOtherSkillById(0L);
